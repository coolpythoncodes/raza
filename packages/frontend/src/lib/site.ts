export const siteConfig = {
    ...
    url: '',
    ogImage: '',
    description: "Join creative contests, submit your entries, vote, and win exciting prizes on our contest platform",
    // links: {
    ...
    keywords: [
        ...
        "The ultimate contest platform – where creativity meets competition. Submit entries, get votes, and take home amazing prizes.",
